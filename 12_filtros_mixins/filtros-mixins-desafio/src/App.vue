<template>
  <div id="app">
    ...
    <fieldset>
      <legend>Filtro local que troca espaços por vírgula</legend>
      <p>
        {{ sentense | changeSpaceToComma }}
      </p>
    </fieldset>

    <fieldset>
      <legend>[COMPUED] - Filtro local que troca espaços por vírgula</legend>
      <p>
    ...
    <fieldset>
      <legend>
        Conta o tamanho de cada palavra e adiciona o valor na string final
      </legend>
      <p>
        {{ sentense | countWordSize }}
      </p>
    </fieldset>
    <fieldset>
      <legend>
        [COMPUED] - Conta o tamanho de cada palavra e adiciona o valor na string
        final
      </legend>
      <p>
